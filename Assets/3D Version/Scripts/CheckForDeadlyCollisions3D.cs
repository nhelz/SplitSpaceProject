...
public class CheckForDeadlyCollisions3D : MonoBehaviour
{
    ...
    //If this object enters a trigger with the tag "Deadly", it tells the LevelTracker to restart the level. 
    //This is so that every laser or any other deadly obstacle doesn't have to have a reference to TrackLevelProgress. 
    //Instead, just set the tag to "Deadly" for any deadly obstacles.
